...
<body style="font-family: 'Raleway', sans-serif;">
    <div class="d-flex p-2" style="height: 450px;	background-color: #FEA5A5; margin: 0px; align-items: left;">
        <div class="container" style="margin: 7% 0% 0% 5%; height: 300px; ">
            <div class="row">
                <div class="col-sm">
                    <iframe width="710" height="400" src="https://www.youtube.com/embed/KQZ9hDDz704"
                ...
                <div class="col-sm-4" style="left: 50px;">
                    <h1 style="text-align: left; font-size: 30px; font-weight: bolder; margin-left:30px;">
                        <?= $data['judul'];?>
                    </h1>
                    <p1 style="font-size: 14px; align-items: left; margin-left:30px;">
                    <?= $data['fakta'];?>
                    </p1>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-8">
                    <div style="padding-top: 5rem; text-align: justify; ">
                        <h5 style="font-weight: bolder;">Asal Video</h5>
                    ...
                    <div style="padding-top: 5rem; text-align: justify; ">
                        <h5 style="font-weight: bolder;">Tentang Channel Youtube</h5>
                        <div class="dropdown-divider" style="border-color: #BE4C4C;"></div>
                        <h7><?= $data['tentang'];?> </h7>
                    </div>
                    <!-- <div style="padding-top: 5rem; text-align: justify; ">
