    ...
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <a class="link" href="#">
                            <img class="d-block w-100" src="<?=BASEURL?>/video/3/pg.jpg" alt="Second slide">
                        </a>
                    </div>
                </div>
        ...
        <div class="col-sm-4" style="background-color: #FEA5A5; margin-right: 70px;">
            ...
            <div class="row">
                <img src="<?=BASEURL?>/video/4/family.jpg" style=" width: 250px;">
            ...
            <div class="row">
                <img src="<?=BASEURL?>/video/4/Teasing.jpg" style=" width: 250px;">
                <button class="btn btn-dark" href="#"
                    style="color: black; background-color: white; text-align: center; height: min-content; margin: 50px 0 0 20px;">
                    Ragam Keluarga
                </button>
